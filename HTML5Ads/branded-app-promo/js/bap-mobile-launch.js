(function(w) {
	...
	'http://ignitecampaigns.com/global/branded-app-promo/js/bap-mobile.min.js'].join( '' ); //change to .min before minifing
	...
	if( typeof window.top.__INITIAL_STATE__ != "undefined" ) {
		...
		if(url === "localhost" || url === "ignitecampaigns.com") {
			domain = "https://cors-anywhere.herokuapp.com/https://1057thehawk.com/rest/carbon/uri/";
		} else {
